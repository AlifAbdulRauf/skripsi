...
<li class="nav-item">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{ route("reservasi.index") }}">Reservasi Admin</a>
            <a class="collapse-item" href="{{ route("reservasi.pasien") }}">Reservasi Pasien</a>
        </div>
    </div>
</li>
...
<!- Nav Item - Pages Collapse Menu -->
<li class="nav-item">
    <a class="nav-link" href="/adatapasien">
