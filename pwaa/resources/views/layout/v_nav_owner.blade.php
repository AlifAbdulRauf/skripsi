 ...
 <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion " id="accordionSidebar">
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center " href="/owner">
    ...
    <hr class="sidebar-divider">
     ...
     <li class="nav-item">
        <a class="nav-link" href="/odatapasien">
            <i class="fas fa-fw fa-tachometer-alt"></i>
            <span>Data Pasien</span></a>
    </li>
     <li class="nav-item">
        <a class="nav-link " href="/odatadokter">
    ...
    <!- Nav Item - Pages Collapse Menu -->
    <li class="nav-item">
        <a class="nav-link" href="{{ route("owner.izin.index") }}">
            <i class="fas fa-fw fa-folder"></i>
            <span>Data Perizinan Dokter</span>
        </a>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
        <a class="nav-link" href="/datapemasukan">
            <i class="fas fa-fw fa-folder"></i>
