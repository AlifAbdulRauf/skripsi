...
<h3 class="font-weight-bold mx-4">Form Edit Reservasi</h3>
<!-- Page Heading -->
<div class="mx-4">
    <form method="POST" action="{{ route('reservasi.update',[$reservasi->reservasi_id]) }}" enctype="multipart/form-data" style="width: 95%;">
        @csrf
        <div class="row">
            <div class="col-lg-12 mb-4">
                <div class="content mr-5">
                    <div class="form-group">
                        <label>Nama</label>
                        <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" value="{{ $reservasi->pasien->nama }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tempat_lahir" class="form-control @error('tempat_lahir') is-invalid @enderror" value="{{ $reservasi->pasien->tempat_lahir }}" required>
                        <div class="invalid-feedback">
                            @error('tempat_lahir')
                                {{ $message }}
                            @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tanggal_lahir" class="form-control @error('tanggal_lahir') is-invalid @enderror" value="{{ $reservasi->pasien->tanggal_lahir }}" required>
                        <div class="invalid-feedback">
                            @error('tanggal_lahir')
                                {{ $message }}
                            @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="pekerjaan" class="form-control @error('pekerjaan') is-invalid @enderror" value="{{ $reservasi->pasien->pekerjaan }}" required>
                        <div class="invalid-feedback">
                            @error('pekerjaan')
                                {{ $message }}
                            @enderror
                    ...
                    <div class="form-group">
                        <label>Alamat</label>
                        <textarea name="alamat" class="form-control @error('alamat') is-invalid @enderror" required>{{ $reservasi->pasien->alamat }}</textarea>
                        <div class="invalid-feedback">
                            @error('alamat')
                                {{ $message }}
                            @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="no_Telp" class="form-control @error('no_Telp') is-invalid @enderror" value="{{$reservasi->pasien->no_Telp }}" required>
                        <div class="invalid-feedback">
                            @error('no_Telp')
                                {{ $message }}
                            @enderror
