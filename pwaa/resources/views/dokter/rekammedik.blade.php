...
<h3 class="font-weight-bold mx-3">Rekam Medik {{ $medik->nama. ' (' .$medik->tanggal. ')' }} </h3>
...
<a type="submit" class="btn btn-success mx-3 mb-5" href="{{ route("dokter.rekampasien.edit", [$medik->reservasi_id]) }}" style="font-size: 16px; font-weight: bold;">Edit Rekam Medik</a>
@endforeach
@endsection
